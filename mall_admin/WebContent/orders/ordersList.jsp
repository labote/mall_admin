	...
	<div class="wrapper">
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<form class="d-none d-sm-inline-block" action="<%=request.getContextPath()%>/orders/ordersList.jsp" method="post">
					<div class="input-group input-group-navbar">
						<input type="hidden" name="rowPerPage" value="<%=rowPerPage%>">
						<input type="text" class="form-control" placeholder="clientNo" aria-label="ClientNo" name="clientNo">
				...
				<div class="container-fluid p-0">
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Orders</strong>&nbsp;List</h3>
						</div>
					</div>
						...
						<div class="col-12 col-xl-6">
							<div class="card flex-fill">
								...
								<%
									if(currentPage > 1){
								%>
									<a href="<%=request.getContextPath()%>/orders/ordersList.jsp?currentPage=<%=currentPage-1%>&rowPerPage=<%=rowPerPage%>&clientNo=<%=clientNo%>"><button class="btn btn-primary btn-sm"><i class="align-middle" data-feather="chevrons-left"></i></button></a>
								<%
									}
								...
								%>
									<a href="<%=request.getContextPath()%>/orders/ordersList.jsp?currentPage=<%=currentPage+1%>&rowPerPage=<%=rowPerPage%>&clientNo=<%=clientNo%>"><button class="btn btn-primary btn-sm"><i class="align-middle" data-feather="chevrons-right"></i></button></a>
								<%
									}
								%>
						</div>
